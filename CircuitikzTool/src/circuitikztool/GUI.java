...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        toolSelector.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                toolSelectorKeyPressed(evt);
            }
        });
        ...
        toolSelector.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Path", "Resistor", "Capacitor", "Inductor", "Diode", "Voltage Source", "Current Source", "GND Node", "VCC Node", "VSS Node", "NPN Transistor", "PNP Transistor", "N-Mos", "P-Mos", "N-IGBT", "P-IGBT", "Opamp 3 Terminal", "Opamp 5 Terminal", "Basic Transformer", "Transformer With Core", "NOS" }));
...
//            log.append("Open command cancelled by user." + newline);
    ...
    // Added 02/02/2021
    private void toolSelectorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_componentListKeyPressed
        keyHandler(evt);
    }//GEN-LAST:event_componentListKeyPressed
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Circuitikz Tool by Matthew James Bellafaire \nProject Github Repo https://github.com/Bellafaire/CircuiTikZ-Tool \n Minor modifications made by Llorenç Fanals Batllori", "About", JOptionPane.INFORMATION_MESSAGE);
        ...
        // https://stackoverflow.com/questions/43952007/java-keylistener-discarding-lower-case-letters
            ...
            switch (evt.getKeyChar()) {
                case 'w': // wire
                    ...
                    break;
                case 'r': // resistor
                    toolSelector.setSelectedIndex(1);
                    break;
                case 'c': // capacitor
                    toolSelector.setSelectedIndex(2);
                    break;
                case 'l': // inductor
                    toolSelector.setSelectedIndex(3);
                    break;
                case 'd': // diode
                    toolSelector.setSelectedIndex(4);
                    break;
                case 'v': // voltage source
                    toolSelector.setSelectedIndex(5);
                    break;
                case 'i': // current source
                    toolSelector.setSelectedIndex(6);
                    break;
                case 'g': // GND node
                    toolSelector.setSelectedIndex(7);
                    break;
                case 'f': // VCC node
                    toolSelector.setSelectedIndex(8);
                    break;
                case 'n': // NMOS
                    toolSelector.setSelectedIndex(12);
                    break;
                case 'p': // PMOS
                    toolSelector.setSelectedIndex(13);
                    break;
                case 'o': // OpAmp 3 terminals
                    toolSelector.setSelectedIndex(16);
                    break;
